...
from PyQt6.QtWidgets import QApplication, QLabel, QWidget, QGridLayout, \
    ...
    QDialog, QVBoxLayout, QComboBox, QToolBar, QStatusBar, QToolBar, QMessageBox
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        find_student_action = QAction(QIcon("icons/search.png"), "Find student", self)
...
class InsertDialog(QDialog):
    ...
    def add_student(self):
        ...
        connection = sqlite3.connect("database.db")
        cursor = connection.cursor()
        cursor.execute("INSERT INTO students (name, course, mobile) VALUES(?, ?, ?)", (student_name, course, mobile))
        connection.commit()
        cursor.close()
        connection.close()
